import ceylon.time.base { monday, tuesday, wednesday, thursday, friday, saturday, sunday, december, january }
import com.redhat.ceylon.sdk.test { assertTrue, assertSame, assertEquals }
...
void testDayOfWeek(){
	...
	variable value dayOfWeek := data_1982_12_13.day; 
    for ( Date date in data_1982_12_13..data_1983_01_01 ) {
        assertEquals( date.day, dayOfWeek++ );
    }
