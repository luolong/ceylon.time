...
shared abstract class Field()
    ...
    doc "Checks that the specified value is valid for this field.
...
doc "The day-of-week, such as Tuesday.
...
doc "The epoch-day, based on the Java epoch of 1970-01-01 (ISO).
...
doc "The week within a year.
     ...
     This field typically used with [[DayOfWeek]].
     This field may have a different meaning in a non-ISO calendar system."
...
doc "The month-of-year, such as March.
...
doc "The epoch month based on the Java epoch of 1970-01-01.
