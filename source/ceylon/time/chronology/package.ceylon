...
doc "Package containing supported chronologies in ceylon.time library.

     A _Chronology_ is a set of functions and methods that define the calendar system. A Chronology is tightly coupled to the actual date implementation of that chronology.
